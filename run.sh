...
false && docker run --rm --label=jekyll --name www.pdfcrun.ch --volume=$(pwd):/srv/jekyll -it -p 127.0.0.1:80:4000 jekyll/jekyll:3.6 jekyll serve
...
docker run --rm --label=jekyll --name www.pdfcrun.ch --volume=$(pwd):/srv/jekyll -it -p 127.0.0.1:80:4000 pdfcrunchjekyll3.6 jekyll serve
